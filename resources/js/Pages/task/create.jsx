...
function create({ customers,employees,ttypes }) {
    ...
    return (
        <AdminLayout>
            <div className="max-w-5xl p-8 mx-auto bg-white rounded-lg shadow-md">
                <h2 className="mb-6 text-2xl font-bold text-gray-800">Add Tasks</h2>
                <form onSubmit={handleSubmit} className="flex flex-wrap">
                    ...
                    <div className='w-full py-5'>
                        <button className='px-6 py-2 text-sm font-medium text-white rounded bg-rose-600'>Add Task</button>
                    </div>
                </form>
            </div>
        </AdminLayout>
