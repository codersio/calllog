...
const Edit = ({ prd }) => {
    ...
    const { data, setData, patch, processing, errors } = useForm({
        product_id: prd.product_code,
        item_name: prd.item_name,
        model_no: prd.model_no,
        brand: prd.brand_id,
        product_category: prd.category_id,
        price: prd.price,
        unit: prd.unit_id,
        image: '',
        product_desc: prd.specification,
    });
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        patch(`/Product-List/${prd.product_id}`, {
            onSuccess: () => {
    ...
    return (
        <AdminLayout>
            <div className="max-w-4xl p-8 mx-auto bg-white rounded-lg shadow-md">
                <h2 className="mb-6 text-2xl font-bold text-gray-800">Edit Product</h2>
