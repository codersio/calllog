...
const IncomeTable = () => {
    ...
    return (
        <AdminLayout>
            <div className="p-4">
                <Link href='/income/create' className='p-2 text-white bg-blue-500 rounded-md'>Create</Link>
                <br />
                <br />
                            ...
                            {incomes.map((income) => (
                                <tr key={income.id} className="border-b">
                                    <td className="px-4 py-2">
                                        {income.first_name} {/* Adjust field based on your actual data */}
                                    </td>
                                    <td className="px-4 py-2">
                                    ...
                                    <td className="px-4 py-2">
                                        <Link href={`/income/${income.id}/edit`} className="px-3 py-1 mr-2 text-white bg-blue-500 rounded">Edit</Link>
                                        <button
