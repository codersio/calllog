...
function ExpenseEntryForm({ initialData = {},customers }) {
...
useEffect(() => {
  ...
  const handleSubmit = (e) => {
    ...
    if (initialData.id) {
        ...
        post(`/amc-expense-update/${initialData.id}`, {
            data: formattedData,
            onSuccess: () => {
  ...
  return (
    ...
    <div className="p-6 mx-auto bg-white rounded-md shadow-md ">
      <h2 className="mb-4 text-lg font-semibold text-gray-700">
        {initialData.id ? 'Edit Expense Entry' : 'Create Expense Entry'}
      </h2>
