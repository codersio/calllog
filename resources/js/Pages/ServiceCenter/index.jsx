        ...
        <AdminLayout>
            <div className='p-6 bg-white rounded-lg shadow'>
                <div className='flex justify-between mb-4'>
                    ...
                    />
                    {
                        props.auth.user.roles[0].name === "admin" || permissions.includes('create_service_center') ?
                            (
                                ...
                                <tr key={emp.id} className="odd:bg-white even:bg-gray-100">
                                    ...
                                    <td className='p-3 text-center border'>
                                        <div className='flex justify-center space-x-3'>
                                            {
                                                props.auth.user.roles[0].name === "admin" || permissions.includes('edit_service_center') ?
                                                    (
