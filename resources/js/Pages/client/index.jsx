        ...
        <AdminLayout>
            <div className='p-6 bg-white rounded-lg shadow'>
                <div className='flex justify-between mb-4'>
                    ...
                    <Link href='Client/create' className='px-4 py-2 text-white bg-blue-500 rounded hover:bg-blue-600'>
                        Add Client
                    </Link>
                    <Link href='archiveclient' className='px-4 py-2 text-white bg-blue-500 rounded hover:bg-blue-600'>
                    Archive Client
                    </Link>
                </div>
    ...
    currentData.map((emp, index) => (
      <tr key={emp.user_id} className="odd:bg-white even:bg-gray-100">
        ...
        <td className="p-3 border">
                            ...
                            <img 
                                src={`storage/${emp.photo}`} // Use the base URL
