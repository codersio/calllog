...
const AddDelars = () => {
    ...
    const handleSubmit = (e) => {
        ...
        post('/delars', {
            onSuccess: () => {
                ...
                notyf.success('Distributor added successfully!');
            },
            onError: () => {
                // Show error notification if there are errors
                notyf.error('Failed to add distributor. Please check your inputs.');
            }
        });
    };
    ...
    return (
        ...
        <div className="max-w-4xl p-8 mx-auto bg-white rounded-lg shadow-md">
            <h2 className="mb-6 text-2xl font-bold text-gray-800">Add Delars</h2>
            <form onSubmit={handleSubmit} className="grid grid-cols-1 gap-6 md:grid-cols-2">
                ...
                <div className="col-span-1 md:col-span-2">
                    ...
                    >
                        {processing ? 'Processing...' : 'Add Distributor'}
                    </button>
                </div>
            </form>
        </div>
