...
const EditDelars = ({ distributor }) => {
    const { data, setData, put, processing, errors } = useForm({
        name: distributor.name || '',
        address: distributor.address || '',
        pin: distributor.pin || '',
        con1: distributor.con1 || '',
        con2: distributor.con2 || '',
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        put(`/delars/${distributor.id}`, {
            onSuccess: () => {
                notyf.success('Distributor updated successfully!');
            },
            onError: () => {
                notyf.error('Failed to update distributor. Please check your inputs.');
            }
        });
    };
    ...
    return (
        <AdminLayout>
            <div className="max-w-4xl p-8 mx-auto bg-white rounded-lg shadow-md">
                <h2 className="mb-6 text-2xl font-bold text-gray-800">Edit Distributor</h2>
