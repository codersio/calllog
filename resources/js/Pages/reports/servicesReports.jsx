...
const ServiceReport = ({ datas, clients }) => {
    ...
    const chartData = {
        ...
        series: [{
            name: "Services",
            data: datas.map(service => service.count) // Update based on the data structure
        }],
        options: {
            ...initialChartData.options,
            xaxis: {
                categories: datas.map(service => service.month), // Update categories based on the data
            }
        }
    };
    ...
    return (
        <AdminLayout>
            <div className="p-8">
                <h2 className="text-2xl font-bold mb-6">Service Reports</h2>
                ...
                <form onSubmit={handleSubmit} className="flex flex-wrap items-center w-full mb-6">
                    ...
                    <div className="p-2 space-x-2">
                        ...
                        <Link href="/service-reports" className="bg-zinc-500 text-white py-2.5 px-4 rounded">
                            Reset
                        </Link>
                    </div>
                </form>
                ...
                <p className="text-lg font-medium mb-4">
                    {`${formValues.startDate} UNTIL ${formValues.endDate}: ${chartData.series[0].data.reduce((acc, val) => acc + val, 0)} SERVICES`}
                </p>
