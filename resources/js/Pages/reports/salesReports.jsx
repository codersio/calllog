...
const SalesReport = ({ datas, clients }) => {
    ...
    const chartData = {
        ...
        series: [{
            name: "Sales",
            data: datas.map(sale => sale.count) // Update based on the data structure
        }],
        options: {
            ...initialChartData.options,
            xaxis: {
                categories: datas.map(sale => sale.month), // Update categories based on the data
            }
        }
    };
            ...
            <div className="p-8">
                ...
                <form onSubmit={handleSubmit} className="flex flex-wrap items-center w-full mb-6">
                    ...
                    <div className="p-2 space-x-2">
                        ...
                        <Link href="/sales-reports" className="bg-zinc-500 text-white py-2.5 px-4 rounded">
                            Reset
                        </Link>
                    </div>
                </form>
                ...
                <p className="text-lg font-medium mb-4">
                    {`${formValues.startDate} UNTIL ${formValues.endDate}: ${chartData.series[0].data.reduce((acc, val) => acc + val, 0)} SALES`}
                </p>
