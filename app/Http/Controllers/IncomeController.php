...
class IncomeController extends Controller
{
    ...
    {
        $incomes = Income::join('tbl_user', 'tbl_user.user_id', '=', 'incomes.customer_id')
            ->select('tbl_user.first_name', 'tbl_user.last_name', 'incomes.status', 'incomes.id', 'incomes.date', 'incomes.main_label')->get();
